...
import { baseUrl, contentType, navigationType } from '../../../constants/constants';
...
import { updateNavigation, handleAzanIqomahGap } from '../../../rtk/features/navigation/navigationSlice';
...
function Azan() {
  ...
  useEffect(() => {
    timeout = setTimeout(() => {
      setPlay(false);
      if (day === 2 && activePrayerTime[0].name === 'dhuhr') {
        dispatch(azanNev(AZAN_NEV_SCREEN.KHOTBAH));
