...
import { useDeleteMasjidUserMutation, useGetMasjidUserQuery, useLazyGetMasjidUserQuery } from '../../rtk/features/api/user.api';
...
function SupperAdmin() {
  ...
  const { handleInputChange } = useHandleSearch('user/user');
