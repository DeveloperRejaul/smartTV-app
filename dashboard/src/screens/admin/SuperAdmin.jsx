...
import { useDeleteMasjidAdminMutation, useGetMasjidAdminQuery, useLazyGetMasjidAdminQuery } from '../../rtk/features/api/user.api';
...
function SuperAdmin() {
  ...
  const { handleInputChange } = useHandleSearch('user/admin');
  return (
